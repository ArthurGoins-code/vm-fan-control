...
VM_HOST_IP = "192.168.1.100"  # Replace with actual VM IP address
VM_HOST_PORT = 8888

# GPU monitoring parameters
GPU_MONITOR_INTERVAL = 30  # seconds (default interval)
MIN_MONITOR_INTERVAL = 5   # Minimum monitoring interval in seconds (when temp is high)
MAX_MONITOR_INTERVAL = 60  # Maximum monitoring interval in seconds (when temp is low)
